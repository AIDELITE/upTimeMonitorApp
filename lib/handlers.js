            ...
            if (!err && userData) {
                ...
                if (hashedPassword == userData.hashedPassword) {
                    ...
                    if (tokenId) {
                        ...
                        callback(400,{'Error':'Could not generate a token'});
                    }
                } else {
                    callback(400, {
...
handlers._tokens.put = (data, callback) => {
    ...
    if(id && extend){
                ...
                if(tokenData.expires > Date.now()){
                    ...
                    _data.update('tokens',id,tokenData,(err)=>{
                        if(!err){
                            ...
                            callback(500,{'Error':'Could not update tokens'});
                        }
                    })
                }else{
        ...
        callback(400, {'Error':'Missing required fields/ Invalid fields'});
    }
}
...
handlers._tokens.delete = (data, callback) => {
    ...
    if (id) {
        ...
        callback(400,{'Error':'Token ID is not valid'});
    }
}
