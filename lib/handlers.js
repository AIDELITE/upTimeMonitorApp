...
handlers.index = (data,callback)=>{
    ...
    if(data.method=='get'){
        ...
        var templateData = {
            ...
            'head.description':'We offer free uptime monitoring for HTTP/HTTPS SITES of any kind',
            'body.class': 'index'
        }
        ...
        helpers.getTemplate('index',templateData,(err,str)=>{
            if(!err && str){
                ...
                helpers.addUniversalTemplates(str,templateData,(err,string)=>{
                    if(!err && string){
...
handlers.accountCreate = (data,callback)=>{
    ...
    if(data.method=='get'){
        ...
        var templateData = {
            'head.title': 'Sign Up',
            'head.description':'This is the sign up process',
